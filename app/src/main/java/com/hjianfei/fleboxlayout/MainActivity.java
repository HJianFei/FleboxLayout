package com.hjianfei.fleboxlayout;
...
public class MainActivity extends AppCompatActivity {
    ...
    private View getFlexboxLayoutItemView(int position) {
        ...
        final TextView itemTv = (TextView) view.findViewById(R.id.item_tv);
        itemTv.setText(tags[position]);
        itemTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MainActivity.this,itemTv.getText().toString(),Toast.LENGTH_SHORT).show();
            }
        });
        return view;
    }
